...
with st.container():
    ...
    with col1:
        ...
        fdn = 0.08*prix_achat
        frais_de_notaires = st.number_input("Frais de notaires (€)", min_value=0.0, max_value=4000000, value=prix_achat, step=100)
    ...
    with col2:
        ...
        apport = st.number_input("Apport personnel (€)", min_value=0, max_value=4000000, value=prix_achat, step=5000)
